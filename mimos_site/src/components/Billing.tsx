...
const Billing = () => (
  <section id="product" className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      <h2 className={styles.heading2}>Controle facil <br className="ss:block hidden"/>billing & invocing</h2>
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}> aaaaaaaaaaaaa </p>
